...
export class WaitlistsDbService extends BaseDatabaseService {
    ...
    public fillable = ['fullName', 'email', 'country', 'accountType', 'founderStage', 'professionalCategory', 'companyName', 'rolePosition', 'biggestChallenge', 'challengeArea', 'bosHelp', 'wantsNewsletter'];
